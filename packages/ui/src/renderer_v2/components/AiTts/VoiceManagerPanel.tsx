...
import { Play, Square, RefreshCw, Trash2, Upload, FolderOpen, Save, Undo2, RotateCcw, Download, Scissors, X, ArrowUp, Wand2 } from 'lucide-react'
import { voiceManagerStore as store, STEP_COLORS, fmtSize, fmtTime } from '../../stores/VoiceManagerStore'
