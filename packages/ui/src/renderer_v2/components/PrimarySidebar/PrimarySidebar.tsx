...
export type PrimaryTab = 'home' | 'terminal' | 'claude' | 'cluster' | 'services' | 'ai-services' | 'ai-llm' | 'ai-image' | 'ai-tts-stt' | 'ai-tools' | 'helper-scripts' | 'model-downloads' | 'flowchart' | 'svg' | 'pages' | 'files' | 'logs' | 'roadmap' | 'fleet' | 'addons' | 'chat'
