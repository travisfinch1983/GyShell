...
export class ClusterService {
  ...
  private static readonly ALLOWED_PREFIXES = ['/api/guests/', '/api/gpu', '/api/storages', '/api/pve/', '/api/ai', '/api/discovery', '/api/scripts', '/api/script-catalog', '/api/civitai', '/api/system', '/api/mcp', '/api/ui-prefs', '/api/proxy', '/api/claude', '/api/hermes']
  ...
  private static readonly LOCAL_PREFIXES = ['/api/civitai', '/api/ai', '/api/system', '/api/mcp', '/api/ui-prefs', '/api/proxy', '/api/claude', '/api/discovery', '/api/pve', '/api/guests', '/api/gpu', '/api/storages', '/api/scripts', '/api/script-catalog', '/api/hermes']
