...
| 6 | **Settings › Models — ProxLab discovery** | `Settings/ProxlabServicesPanel.tsx`, `services/ProxlabDiscovery.ts` (hardcoded the old decommissioned ProxLab host) | OLD: ProxLab proxy — **probed 2026-07-03: host DEAD (conn refused)**; section is dark at runtime | **DEAD** (repoint or remove) | **P0** |
